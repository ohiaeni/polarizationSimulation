...
function preload() {
    spectrumSheet = loadTable("spectrumData/spectrumSheet.csv");
    rgbSheet = loadTable("spectrumData/rgbSheet.csv");
    cmfSheet = loadTable("spectrumData/cmfSheet.csv");
    lightSourceSpectrumSheet = loadTable("spectrumData/lightSourceSpectrumSheet.csv");
}
